 ...
 * @param width          Texture width
 * @param height         Texture height
 * @param resourceFinder Function pointer to resolve model file path
 * @return               If succeed return BEF_EFFECT_RESULT_SUC, other value please see bef_effect_ai_public_define.h
 */
BEF_SDK_API bef_effect_result_t bef_effect_ai_init_with_resource_finder(bef_effect_handle_t handle, int width, int height, bef_ai_resource_finder resourceFinder, const char* deviceName);
...
BEF_SDK_API void bef_effect_ai_set_bgm_mute(bef_effect_handle_t handle, bool bIsMute);

BEF_SDK_API bef_effect_result_t 
bef_effect_ai_remove_render_cache_external_texture(bef_effect_handle_t handle, const char* key);

BEF_SDK_API bef_effect_result_t 
bef_effect_ai_set_render_cache_external_texture(bef_effect_handle_t handle, const char* key, int texture, int width, int height);

BEF_SDK_API bef_effect_result_t 
bef_effect_ai_set_render_cache_external_texture_with_rotation(bef_effect_handle_t handle, const char* key, int texture, int width, int height, bef_ai_rotate_type rotation);
...
BEF_SDK_API bef_effect_result_t bef_effect_ai_enable_algorithm_picture_mode(bef_effect_handle_t handle, bool pictureModeEnable);
